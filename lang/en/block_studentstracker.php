...
$string['confirmsendmessage'] = 'Confirm send message';
...
$string['messagetemplate'] = 'Hello, I noticed that you have not logged in to the course for the past few days.
If you have experienced any difficulties accessing the course or need assistance, please do not hesitate to contact me. Best regards,';
$string['nogroups'] = 'None (all users)';
$string['pluginname'] = 'Students tracker';
$string['predefined_messagetemplate'] = 'Predefined message';
$string['predefined_messagetemplate_help'] = 'Enter a predefined message that you can quickly send to flagged students. This message is personal to you for this course and is not visible to or used by other teachers.';
